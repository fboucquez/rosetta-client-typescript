...
export interface Allow {
     ...
     * @memberof Allow
     */
    block_hash_case?: Case | null;
    /**
     *
     * @type {Case}
     * @memberof Allow
     */
    transaction_hash_case?: Case | null;
}
...
export function AllowFromJSONTyped(json: any, ignoreDiscriminator: boolean): Allow {
    ...
    return {
        ...
        block_hash_case: !exists(json, 'block_hash_case') ? undefined : CaseFromJSON(json['block_hash_case']),
        transaction_hash_case: !exists(json, 'transaction_hash_case') ? undefined : CaseFromJSON(json['transaction_hash_case']),
    };
}
...
export function AllowToJSON(value?: Allow | null): any {
    ...
    return {
        ...
        block_hash_case: CaseToJSON(value.block_hash_case),
        transaction_hash_case: CaseToJSON(value.transaction_hash_case),
    };
}
