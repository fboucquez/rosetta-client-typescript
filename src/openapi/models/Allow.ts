...
export function AllowFromJSONTyped(json: any, ignoreDiscriminator: boolean): Allow {
    ...
    return {
        ...
        balance_exemptions: !exists(json, 'balance_exemptions')
            ? undefined
            : (json['balance_exemptions'] as Array<any>).map(BalanceExemptionFromJSON),
...
export function AllowToJSON(value?: Allow | null): any {
    ...
    return {
        ...
        balance_exemptions:
            value.balance_exemptions === undefined ? undefined : (value.balance_exemptions as Array<any>).map(BalanceExemptionToJSON),
